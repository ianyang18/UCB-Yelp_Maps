...
def make_restaurant(name, location, categories, price, reviews):
    ...
    return [name, dict([('location', location), ('categories', categories), ('price', price), ('reviews', reviews)])]
